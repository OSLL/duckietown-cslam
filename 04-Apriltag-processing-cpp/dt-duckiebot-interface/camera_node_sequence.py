...
class CameraNode(object):
    ...
    def __init__(self):
        ...
        self.pub_img = rospy.Publisher("~image/compressed", Image, queue_size=1)
    ...
    def startCapturing(self):
        ...
        while not self.is_shutdown and not rospy.is_shutdown():
            ...
            try:
                self.camera.capture_sequence(gen, 'bgr', use_video_port=True, splitter_port=0)
    ...
    def grabAndPublish(self, stream, publisher):
        while not self.update_framerate and not self.is_shutdown and not rospy.is_shutdown():
            ...
            image_msg = Image()
            image_msg.height = self.res_h
            image_msg.width = self.res_w
